...
export const getV2gamesUniverseIdmedia = {
  method: 'get' as const,
...
export const getV2groupsGroupIdgames = {
  method: 'get' as const,
...
export const getV2groupsGroupIdgamesV2 = {
  method: 'get' as const,
...
export const getV2usersUserIdfavoritegames = {
  method: 'get' as const,
...
export const getV2usersUserIdgames = {
  method: 'get' as const,
