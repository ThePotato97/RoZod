...
export const getV2avataravatar = {
  method: 'get' as const,
...
export const postV2avatarsetBodyColors = {
...
export const postV2avatarsetWearingAssets = {
  method: 'post' as const,
...
export const getV2avatarusersUserIdavatar = {
  method: 'get' as const,
...
export const patchV2outfitsUserOutfitId = {
...
export const postV2outfitsUserOutfitIdupdate = {
  method: 'post' as const,
...
export const postV2outfitscreate = {
  method: 'post' as const,
